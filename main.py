...
def main():
    for cluster in clusters:
        ...
        notice_msg = (
            ...
            f"\n"
            f"\n"
            f":one: *임산부* 는 *임신중인 여성* 혹은 *산후 1년 이내이신분* 들을 포함합니다. (근로기준법 제65조 1항)\n"
            f":two: *임산부* 는 *고열 작업* 및 *한랭 작업(드라이 아이스 등)*, *중량물을 취급하는 업무* 등에 근로가 *불가* 합니다. (근로기준법 제65조 2항, 근로기준법 시행령 제40조)\n"
            f":three: *임산부* 는 *야근근로, 연장근로 및 휴일근로* 가 *불가* 합니다. (근로기준법 제70조 2항, 제74조 5항)\n"
            f"*본인 혹은 주변 동료가 임산부 이신 경우, 모성 보호를 위해 전담 창구로 말씀해주시길 바랍니다.*\n" 
            f"*(전담 창구 : 각 센터 인사총무팀)*\n\n"
            f":gift: *출산 축하 선물 및 축하금*\n\n"
