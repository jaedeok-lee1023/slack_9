...
def main():
    for cluster in clusters:
        ...
        notice_msg = (
            ...
            f"*2025년 02월 23일 부터 육아지원제도가 변경 되었으며 첨부된 카드뉴스를 통해 확인 하실 수 있습니다!!*\n\n"
            f"<https://50072f98-e1d6-4b35-b1e5-5564ad1fcebf.usrfiles.com/ugd/50072f_763873d7e3c447c3960e863ea0b601f0.pdf|육아지원제도_변경사항_안내>* :point_left: *(Click)*\n\n"
            f"감사합니다.\n"
        )
